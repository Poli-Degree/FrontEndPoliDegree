...
@Component({
  selector: 'app-proyect-list-jurado',
  templateUrl: './proyect-list-jurado.component.html',
  styleUrls: ['./proyect-list-jurado.component.css']
})
export class ProyectListJuradoComponent implements OnInit {
