...
@Component({
  selector: 'app-proyect-list-tutor',
  templateUrl: './proyect-list-tutor.component.html',
  styleUrls: ['./proyect-list-tutor.component.css']
})
export class ProyectListTutorComponent implements OnInit {
